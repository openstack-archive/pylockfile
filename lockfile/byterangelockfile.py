...
from . import (_SharedBase, LockTimeout, LockError)
        ...
        while True:
            ...
            try:
                ...
                if e.errno in (errno.EACCES, errno.EAGAIN):
                    ...
                    raise LockError("Unable to acquire lock on `%s` due to"
                                    " %s" % (self.path, e))
...
if os.name == 'nt':
    import msvcrt
    ByteRangeLockFile = _WindowsLock
else:
    import fcntl
    ByteRangeLockFile = _FcntlLock
